...
import com.mSIHAT.hcp.fragements.Welcomepage;
...
Boolean login = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean opened = editor4.getBoolean("firstpage",false);
...
Log.e("Sdsd","opened");
            ...
            editor2.putBoolean("firstpage", true);
            editor2.commit();
          ...
          //  getSupportActionBar().hide();
           ...
           // getSupportActionBar().hide();
            final AppCompatActivity act = this;
           getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.move, R.anim.moveout).
...
if(!login){
    ...
    SharedPreferences.Editor editor2 = getSharedPreferences(Constants.SHARED_DB, MODE_PRIVATE).edit();
    editor2.putBoolean("opened", false);
    editor2.putBoolean("firstpage", false);
    editor2.commit();
    this.finish();
}
    }
