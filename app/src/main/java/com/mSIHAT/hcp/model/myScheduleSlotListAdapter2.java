...
public class myScheduleSlotListAdapter2 extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.topbar = (RelativeLayout) convertView.findViewById(R.id.topbarmain);
        holder.bottombar = (RelativeLayout) convertView.findViewById(R.id.bottombarmain);
        ...
        if(position != 0){
            holder.topbar.setVisibility(View.GONE);
        ...
        if(listData.size() > 1) {
Log.e("hjdf",String.valueOf(listData.size()));
            Log.e("hjdf",String.valueOf(position));
            ...
            if(position > 0){
                if (listData.get(position).getStartSlot() != listData.get(position - 1).getEndSlot()) {
